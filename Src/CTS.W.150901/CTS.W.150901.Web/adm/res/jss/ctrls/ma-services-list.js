// MAServicesEntryCtrl
ctrls.controller('MAServicesListCtrl', ['$scope', '$state', '$stateParams', '$window', function ($scope, $state, $stateParams, $window) {
    ...
    $scope.init = function () {
        $pc({
            action: 'InitLayout',
            url: '/adm/hdl/ma/services/list.ashx',
    ...
    $scope.filter = function () {
        $pc({
            ...
            data: function () {
                ...
                data.ServiceName = $scope.data.HdnServiceName;
    ...
    $scope.add = function () {
        var fnYes = function () {
            $pc(function () {
                ...
                $state.go('master-services-list-entry', params);
            });
        };
    ...
    // Xử lý thay đổi tên
    $scope.blurServiceName = function (obj) {
        $pc(function () {
    ...
    $scope.search = function () {
        var fnYes = function () {
            $pc(function () {
                ...
                $scope.data.HdnServiceName = $scope.data.ServiceName;
