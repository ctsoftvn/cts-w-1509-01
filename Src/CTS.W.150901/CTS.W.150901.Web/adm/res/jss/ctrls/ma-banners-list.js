// MABannersEntryCtrl
ctrls.controller('MABannersListCtrl', ['$scope', '$state', '$stateParams', '$window', function ($scope, $state, $stateParams, $window) {
    ...
    $scope.init = function () {
        $pc({
            action: 'InitLayout',
            url: '/adm/hdl/ma/banners/list.ashx',
    ...
    $scope.filter = function () {
        $pc({
            ...
            data: function () {
                ...
                data.BannerName = $scope.data.HdnBannerName;
    ...
    $scope.add = function () {
        var fnYes = function () {
            $pc(function () {
                ...
                $state.go('master-banners-list-entry', params);
            });
        };
    ...
    // Xử lý thay đổi tên
    $scope.blurBannerName = function (obj) {
        $pc(function () {
            obj.BannerName = $dataHelper.toSearchName(obj.BannerName);
        });
    };
    // Xử lý tìm kiếm
    $scope.search = function () {
        var fnYes = function () {
            $pc(function () {
                ...
                $scope.data.HdnBannerName = $scope.data.BannerName;
