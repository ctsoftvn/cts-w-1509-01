...
using LogicRoom = CTS.W._150901.Models.Domain.Logic.Client.Room;

namespace CTS.W._150901.Web
{
    public partial class reservation : PageBase
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            var request = new BasicRequest();
            request.Add("Slug", "reservation");
        ...
        public void getRooms()
        {
            ...
            var listRooms = PageCom.GetValue<IList<object>>(responseRoom, "ListRoomType");
