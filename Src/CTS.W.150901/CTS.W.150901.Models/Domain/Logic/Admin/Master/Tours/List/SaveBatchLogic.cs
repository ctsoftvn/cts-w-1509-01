...
namespace CTS.W._150901.Models.Domain.Logic.Admin.Master.Tours.List
{
    /// <summary>
    /// SaveBatchLogic
    /// </summary>
    public class SaveBatchLogic
    {
        ...
        private SaveBatchDataModel SaveInfo(SaveBatchDataModel inputObject) {
            ...
            var listUpdate = DataHelper.CreateList<TourObject>();
            // Map dữ liệu
            ...
            foreach (var info in listBasicLocale) {
                ...
                var listLocaleDb = processDao.GetListOtherLocale(basicLocale, info.TourCd);
