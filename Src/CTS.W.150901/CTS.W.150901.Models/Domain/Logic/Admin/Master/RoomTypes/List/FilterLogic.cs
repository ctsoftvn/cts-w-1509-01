...
namespace CTS.W._150901.Models.Domain.Logic.Admin.Master.RoomTypes.List
{
    /// <summary>
    /// FilterLogic
    /// </summary>
    public class FilterLogic
    {
        ...
        /// Lấy đối tượng pager
        /// </summary>
        private PagerInfoModel<RoomTypeObject> GetPagerData(FilterDataModel inputObject) {
            // Khởi tạo biến cục bộ
            var pagerResult = new PagerInfoModel<RoomTypeObject>();
