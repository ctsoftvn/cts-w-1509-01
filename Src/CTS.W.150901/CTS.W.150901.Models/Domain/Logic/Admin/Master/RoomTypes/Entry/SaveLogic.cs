    ...
    public class SaveLogic
    {
        ...
        private void Check(SaveDataModel inputObject) {
            ...
            if (DataCheckHelper.IsNull(dataInfo.TypeCd)) {
                msgs.Add(MessageHelper.GetMessage("E_MSG_00001", "ADM_MA_ROOMTYPES_00001"));
            }
            if (DataCheckHelper.IsNull(dataInfo.TypeName)) {
                msgs.Add(MessageHelper.GetMessage("E_MSG_00001", "ADM_MA_ROOMTYPES_00002"));
            }
            ...
            if (inputObject.IsAdd && (isExist)) {
                msgs.Add(MessageHelper.GetMessage("E_MSG_00017", "ADM_MA_ROOMTYPES_00006"));
            }
            // Kiểm tra dữ liệu tồn tại trường hợp status là edit
            if (inputObject.IsEdit && (!isExist)) {
                msgs.Add(MessageHelper.GetMessage("E_MSG_00016", "ADM_MA_ROOMTYPES_00006"));
            }
            // Kiểm tra danh sách lỗi
            if (!DataCheckHelper.IsNull(msgs)) {
                throw new ExecuteException(msgs);
            ...
            var isUnique = masterDataCom.IsUniqueRoomType(dataInfo.TypeCd, dataInfo.Slug);
            if (!isUnique) {
        ...
        private SaveDataModel SaveInfo(SaveDataModel inputObject) {
            ...
            var processDao = new MasterRoomTypesDao();
            // Map dữ liệu
            ...
            if (inputObject.IsAdd) {
                ...
                foreach (var info in listLocale) {
                    ...
                    info.Price = dataInfo.Price;
                    info.AdultPerRoom = dataInfo.AdultPerRoom;
