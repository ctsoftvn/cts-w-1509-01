...
namespace CTS.W._150901.Models.Domain.Logic.Admin.Master.Accoms.List
{
    /// <summary>
    /// FilterLogic
    /// </summary>
    public class FilterLogic
    {
        ...
        /// Lấy đối tượng pager
        /// </summary>
        private PagerInfoModel<AccomObject> GetPagerData(FilterDataModel inputObject) {
            // Khởi tạo biến cục bộ
            var pagerResult = new PagerInfoModel<AccomObject>();
